...
\label{chi2 formula}
\end{align}
The estimated map $\hatm$ is the one that minimizes $\chi^2(\vbm)$.
\begin{align}
\hatm = \PPinv{N} \Pdagger \inv{N} \vbd \label{map making equation}
\end{align}
This is also called the \textit{map making equation}.
...
\\&\quad= \tau \PPinv{} \Pdagger \inv{\qty(\tau I + \frac{1}{\lambda}\Nbar)} \vbd
\end{aligned}
